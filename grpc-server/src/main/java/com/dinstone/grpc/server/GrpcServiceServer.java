...
public class GrpcServiceServer {
	...
	public static void main(String[] args) {
		ServerServiceDefinition serviceDefinition = ServerInterceptors.intercept(new HelloServiceImpl(), new AuthInterceptor());
		Server server = ServerBuilder.forPort(9898).addService(serviceDefinition).build();
